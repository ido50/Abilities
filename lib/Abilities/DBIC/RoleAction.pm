package Abilities::DBIC::RoleAction;
...
__PACKAGE__->belongs_to('action' => 'Action', 'action_name');

=head1 NAME

Abilities::DBIC::RoleAction - Base class for DBIx::Class role-action
relationships.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Abilities::DBIC::RoleAction
