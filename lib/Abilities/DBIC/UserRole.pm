package Abilities::DBIC::UserRole;

use strict;
use warnings;
use base qw/DBIx::Class::Core Abilities/;

__PACKAGE__->belongs_to('user' => 'User', 'user_id');
__PACKAGE__->belongs_to('role' => 'Role', 'role_name');

=head1 NAME

Abilities::DBIC::RoleAction - Base class for DBIx::Class user-role
relationships.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Abilities::DBIC::UserRole
